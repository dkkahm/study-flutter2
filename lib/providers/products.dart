...
import 'package:flutter_app3/exceptions/http_exception.dart';
...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url = 'https://study-flutter2.firebaseio.com/products.json';
    ...
    if (resBody != null) {
      ...
      resBody.forEach((productId, value) {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      ...
      final url = 'https://study-flutter2.firebaseio.com/products/$id.json';
